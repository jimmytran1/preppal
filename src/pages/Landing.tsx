  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/Landing-Hero.png')" }} />
...
estimated macros — in under 30 seconds.
          ...
          <p className="text-sm text-white font-body">
            No account needed&nbsp;·&nbsp;Supports TikTok, YouTube, Instagram&nbsp;·&nbsp;AI-powered extraction
          </p>
        </div>

        {/* Torn paper bottom edge */}
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg viewBox="0 0 1200 60" preserveAspectRatio="none" className="w-full h-16 fill-cream-light">
      ...
      {/* Why PrepPal */}
      <section className="bg-green py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-8">
          <h2 className="heading-lg text-white">WHY PREPPAL?</h2>
          <p className="body-text text-white max-w-2xl">
            Stop screenshot-ing recipes and losing track of what you ate. PrepPal turns
            any social media recipe into a structured, searchable meal plan — in seconds.
          </p>
          <a
            href="/signup"
